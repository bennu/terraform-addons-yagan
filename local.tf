locals {
  ...
  dex_image                = "dexidp/dex:v2.29.0"
  external_dns_version     = "5.0.0"
  gangway_image            = "gcr.io/heptio-images/gangway:v3.2.0"
  gatekeeper_version       = "3.5.1"
  ingress_version          = "3.34.2"
  klum_image               = "ibuildthecloud/klum:v0.0.1-amd64"
  kured_version            = "2.7.0"
  metallb_controller_image = "metallb/controller:v0.10.2"
  metallb_speaker_image    = "metallb/speaker:v0.10.2"
